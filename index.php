<!--ACA COMIENZA LA PAGINA CONTIENE TIPO DE DOCUMENTO IDIOMA-->
<!DOCTYPE html>
<html lang="es">
...
<meta charset="utf-8">
<title>SOLUCIONES MACGYBER</title>
...
<body>
<a id="whatsapp"href="https://api.whatsapp.com/send?phone=573014521736"><img src="imagenes/whatsapp.png" alt=""></a>
<header>
  <div class="menu">
    <div class="contenedor">
      <p class="logo">SOLUCIONES MACGYBER</p>
    ...
    <div class="contenedor" id="contenedor-titulo-flex">
      <div class="contenedor-titulo">
        <h1>SOLUCIONES MACGYBER</h1>
        <h2>El Ingenio A Su Servicio</h2>
        <a href="">VER MIS TRABAJOS</a>
      </div>
    </div>

</header>
<!--AQUI EMPEIZA SEGUNDA SECCION "SOBRE MI"-->
<main>
<section id="sobre-mi">
  <div class="contenedor">
    <h3>Sobre mi</h3>
...
<!--AQUI EMPIESA LA TERCER SECCION "SERVIVIOS"-->
...
<section id="mis-trabajos">
  <div class="contenedor">
    ...
    <div class="owl-carousel owl-theme">
      <!--PARA COLOCAR IMAGENES EN EL CARRUSEL SE PODRAN AGREGAR LAS QUE GUSTE-->
        <div class="item"><a href="www.google.com"><img src="imagenes/sassy.jpg"><p>Sassy Kids</p></a></div>
        <div class="item"><a href=""><img src="imagenes/chaia.jpg"><p>Chaia</p></a></div>
        <div class="item"><a href=""><img src="imagenes/alimentar.jpg"><p>Alimentar</p></a></div>
        <div class="item"><a href=""><img src="imagenes/sassy.jpg"><p>Sassy Kids</p></a></div>
        <div class="item"><a href=""><img src="imagenes/sassy.jpg"><p>Sassy Kids</p></a></div>
        <div class="item"><a href=""><img src="imagenes/sassy.jpg"><p>Sassy Kids</p></a></div>
    </div>
  </div>
...
<!--SECCION DE QUE ESPERAS PARA TENER TU PAGINA WEB-->
...
<!--ESTE TITULO LO QUE LE MOSTRARA AL USUARIO CUANDO MANDE EL FORMULARIO-->
  ...
  <div class="contenedor">
    ...
    <form action="envio-formulario.php" method="post" enctype="multipart/form-data">
      ...
      <div class="mail"><img src="imagenes/mail-icon.png" alt="">esteban3261g@gmail.com</div>
      <div class="whatsapp"><img src="imagenes/whatsapp-icon.png" alt="">3014521736</div>
      </div>
  </div>
</section>
</main>
...
<div class="contenedor">
  <div class="redes">
    ...
    <p>2020 Soluciones Macgyber | Diseñador Web Colombia. Todos los derechos reservados</p>
</div>
</footer>
...
<script
  ...
  <!--ESTE CODIGO ME PERMITE CONFIGURAR EL CARUSELL ACTIVAR CANTIDAD Y EN QUE EQUIPOS MAXIMO ITEMS DEBEN DE APARECER-->
